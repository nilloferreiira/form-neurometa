    ...
    return(
        ...
        <div className="w-1/5 p-2 m-4 flex flex-col gap-5">
          ...
          {/* <Select {...register("gender")}>
            ...
            <SelectContent className="bg-zinc-800">
              <SelectItem className="bg-zinc-900 text-zinc-50" value="M">Masculino</SelectItem>
              <SelectItem className="bg-zinc-900 text-zinc-50" value="F">Feminino</SelectItem>
              <SelectItem className="bg-zinc-900 text-zinc-50" value="O">Prefiro não indentificar</SelectItem>
            </SelectContent>
          </Select> */}
        ...
        <div className="w-1/5 p-2 m-4 flex flex-col gap-5">
         ...
         {/* <Select {...register("uf")}>
            ...
            <SelectContent className="bg-zinc-800">
              <SelectItem className="bg-zinc-900 text-zinc-50" value="SE">SE</SelectItem>
            </SelectContent>
          </Select> */}
          <Input
            className="bg-transparent"
